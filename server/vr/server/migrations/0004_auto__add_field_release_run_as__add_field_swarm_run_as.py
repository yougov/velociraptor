...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.run_as'
        db.add_column('deployment_release', 'run_as',
                      self.gf('django.db.models.fields.CharField')(default='nobody', max_length=32),
                      keep_default=False)

        # Adding field 'Swarm.run_as'
        db.add_column('deployment_swarm', 'run_as',
                      self.gf('django.db.models.fields.CharField')(default='nobody', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.run_as'
        db.delete_column('deployment_release', 'run_as')

        # Deleting field 'Swarm.run_as'
        db.delete_column('deployment_swarm', 'run_as')
