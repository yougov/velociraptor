...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OSImage.base_image_name'
        db.add_column('deployment_os_image', 'base_image_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OSImage.provisioning_script_url'
        db.add_column('deployment_os_image', 'provisioning_script_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OSImage.base_image_name'
        db.delete_column('deployment_os_image', 'base_image_name')

        # Deleting field 'OSImage.provisioning_script_url'
        db.delete_column('deployment_os_image', 'provisioning_script_url')
