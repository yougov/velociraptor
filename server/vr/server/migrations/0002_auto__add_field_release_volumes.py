...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Release.volumes'
        db.add_column('deployment_release', 'volumes',
                      self.gf('vr.server.fields.YAMLListField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Release.volumes'
        db.delete_column('deployment_release', 'volumes')
