...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OSImage.file'
        db.alter_column('deployment_os_image', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'OSImage.file'
        db.alter_column('deployment_os_image', 'file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))
