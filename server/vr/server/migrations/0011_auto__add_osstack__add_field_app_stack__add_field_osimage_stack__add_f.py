...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OSStack'
        db.create_table('deployment_os_stack', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('desc', self.gf('django.db.models.fields.TextField')()),
            ('base_image_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('provisioning_script', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('server', ['OSStack'])

        # Adding field 'App.stack'
        db.add_column('deployment_app', 'stack',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.OSStack'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OSImage.stack'
        db.add_column('deployment_os_image', 'stack',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.OSStack'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OSImage.base_image_url'
        db.add_column('deployment_os_image', 'base_image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OSImage.build_log'
        db.add_column('deployment_os_image', 'build_log',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OSImage.active'
        db.add_column('deployment_os_image', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OSStack'
        db.delete_table('deployment_os_stack')

        # Deleting field 'App.stack'
        db.delete_column('deployment_app', 'stack_id')

        # Deleting field 'OSImage.stack'
        db.delete_column('deployment_os_image', 'stack_id')

        # Deleting field 'OSImage.base_image_url'
        db.delete_column('deployment_os_image', 'base_image_url')

        # Deleting field 'OSImage.build_log'
        db.delete_column('deployment_os_image', 'build_log')

        # Deleting field 'OSImage.active'
        db.delete_column('deployment_os_image', 'active')
