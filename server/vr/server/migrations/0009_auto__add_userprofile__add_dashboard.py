...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('server_userprofile', (
            ...
            ('default_dashboard', self.gf('django.db.models.fields.related.ForeignKey')(related_name='def+', to=orm['server.Dashboard'])),
        ))
        db.send_create_signal('server', ['UserProfile'])

        # Adding M2M table for field quick_dashboards on 'UserProfile'
        db.create_table('server_userprofile_quick_dashboards', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['server.userprofile'], null=False)),
            ('dashboard', models.ForeignKey(orm['server.dashboard'], null=False))
        ))
        db.create_unique('server_userprofile_quick_dashboards', ['userprofile_id', 'dashboard_id'])

        # Adding model 'Dashboard'
        db.create_table('server_dashboard', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal('server', ['Dashboard'])

        # Adding M2M table for field apps on 'Dashboard'
        db.create_table('server_dashboard_apps', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dashboard', models.ForeignKey(orm['server.dashboard'], null=False)),
            ('app', models.ForeignKey(orm['server.app'], null=False))
        ))
        db.create_unique('server_dashboard_apps', ['dashboard_id', 'app_id'])

        # Adding M2M table for field editors on 'Dashboard'
        db.create_table('server_dashboard_editors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dashboard', models.ForeignKey(orm['server.dashboard'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('server_dashboard_editors', ['dashboard_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field quick_dashboards on 'UserProfile'
        db.delete_table('server_userprofile_quick_dashboards')

        # Deleting model 'Dashboard'
        db.delete_table('server_dashboard')

        # Removing M2M table for field apps on 'Dashboard'
        db.delete_table('server_dashboard_apps')

        # Removing M2M table for field editors on 'Dashboard'
        db.delete_table('server_dashboard_editors')
    ...
    models = {
        ...
        'server.dashboard': {
            ...
            'editors': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'server.userprofile': {
            ...
            'default_dashboard': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'def+'", 'to': "orm['server.Dashboard']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quick_dashboards': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'quick+'", 'symmetrical': 'False', 'to': "orm['server.Dashboard']"}),
