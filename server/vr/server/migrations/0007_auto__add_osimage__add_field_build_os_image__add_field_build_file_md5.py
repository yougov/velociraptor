...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OSImage'
        db.create_table('deployment_os_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('file_md5', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
        ))
        db.send_create_signal('server', ['OSImage'])

        # Adding field 'Build.os_image'
        db.add_column('deployment_build', 'os_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['server.OSImage'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Build.file_md5'
        db.add_column('deployment_build', 'file_md5',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OSImage'
        db.delete_table('deployment_os_image')

        # Deleting field 'Build.os_image'
        db.delete_column('deployment_build', 'os_image_id')

        # Deleting field 'Build.file_md5'
        db.delete_column('deployment_build', 'file_md5')
