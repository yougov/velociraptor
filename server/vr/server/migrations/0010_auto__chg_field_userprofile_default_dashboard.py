...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.default_dashboard'
        db.alter_column('server_userprofile', 'default_dashboard_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['server.Dashboard']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.default_dashboard'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.default_dashboard' and its values cannot be restored.")
    ...
    models = {
        ...
        'server.dashboard': {
            ...
            'editors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'server.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'quick_dashboards': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'quick+'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['server.Dashboard']"}),
