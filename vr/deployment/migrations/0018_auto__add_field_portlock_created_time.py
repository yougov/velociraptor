...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortLock.created_time'
        db.add_column('deployment_portlock', 'created_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True,
                        default=datetime.datetime.now(), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PortLock.created_time'
        db.delete_column('deployment_portlock', 'created_time')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 15, 58, 52, 471733)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 15, 58, 52, 471640)'}),
