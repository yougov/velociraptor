...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # For each swarm, copy swarm.squad.balancer to swarm.balancer
        for swarm in orm.Swarm.objects.all():
            swarm.balancer = swarm.squad.balancer
            swarm.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for swarm in orm.Swarm.objects.all():
            swarm.squad.balancer = swarm.balancer
            swarm.squad.save()
