...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BuildPack.repo_type'
        db.add_column('deployment_buildpack', 'repo_type',
                      self.gf('django.db.models.fields.CharField')(default='git', max_length=10),
                      keep_default=False)

        # Adding field 'App.repo_type'
        db.add_column('deployment_app', 'repo_type',
                      self.gf('django.db.models.fields.CharField')(default='hg', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BuildPack.repo_type'
        db.delete_column('deployment_buildpack', 'repo_type')

        # Deleting field 'App.repo_type'
        db.delete_column('deployment_app', 'repo_type')
