...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('deployment_portlock', (
            ...
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deployment.Host'])),
            ('port', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('deployment', ['PortLock'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 11, 38, 45, 151700)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 28, 11, 38, 45, 151580)'}),
