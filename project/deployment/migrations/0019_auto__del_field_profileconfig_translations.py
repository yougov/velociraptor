...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProfileConfig.translations'
        db.delete_column('deployment_profileconfig', 'translations')


    def backwards(self, orm):
        
        # Adding field 'ProfileConfig.translations'
        db.add_column('deployment_profileconfig', 'translations', self.gf('deployment.fields.YAMLDictField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 9, 12, 28, 235206)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 1, 9, 12, 28, 235089)'}),
        ...
        'deployment.swarm': {
            'Meta': {'ordering': "['profile__app__name']", 'unique_together': "(('profile', 'squad', 'proc_name'),)", 'object_name': 'Swarm'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
