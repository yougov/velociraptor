...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Squad', fields ['name']
        db.create_unique('deployment_squad', ['name'])

        # Adding unique constraint on 'App', fields ['name']
        db.create_unique('deployment_app', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'App', fields ['name']
        db.delete_unique('deployment_app', ['name'])

        # Removing unique constraint on 'Squad', fields ['name']
        db.delete_unique('deployment_squad', ['name'])
