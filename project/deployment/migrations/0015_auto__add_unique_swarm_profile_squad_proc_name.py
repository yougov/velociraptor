...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Swarm', fields ['profile', 'squad', 'proc_name']
        db.create_unique('deployment_swarm', ['profile_id', 'squad_id', 'proc_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Swarm', fields ['profile', 'squad', 'proc_name']
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 23, 9, 389180)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 23, 9, 389073)'}),
