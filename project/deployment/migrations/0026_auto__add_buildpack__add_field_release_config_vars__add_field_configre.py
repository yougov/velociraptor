...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('deployment', ['BuildPack'])

        # Adding field 'Release.config_vars'
        db.add_column('deployment_release', 'config_vars',
                      self.gf('deployment.fields.YAMLDictField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConfigRecipe.config_vars'
        db.add_column('deployment_configrecipe', 'config_vars',
                      self.gf('deployment.fields.YAMLDictField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Build.config_vars'
        db.add_column('deployment_build', 'config_vars',
                      self.gf('deployment.fields.YAMLDictField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Release.config_vars'
        db.delete_column('deployment_release', 'config_vars')

        # Deleting field 'ConfigRecipe.config_vars'
        db.delete_column('deployment_configrecipe', 'config_vars')

        # Deleting field 'Build.config_vars'
        db.delete_column('deployment_build', 'config_vars')
