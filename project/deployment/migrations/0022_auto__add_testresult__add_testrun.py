...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('deployment_testresult', (
            ...
            ('run', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deployment.TestRun'])),
        ...
        db.send_create_signal('deployment', ['TestResult'])
        ...
        db.send_create_signal('deployment', ['TestRun'])
    ...
    models = {
        ...
        'deployment.testresult': {
            ...
            'run': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['deployment.TestRun']"}),
