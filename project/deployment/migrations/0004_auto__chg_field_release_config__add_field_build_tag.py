...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('deployment_release', 'config', self.gf('django.db.models.fields.TextField')(null=True))

        # Adding field 'Build.tag'
        db.add_column('deployment_build', 'tag', self.gf('django.db.models.fields.CharField')(default='sometag', max_length=50), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Build.tag'
        db.delete_column('deployment_build', 'tag')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 17, 10, 34, 433007)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 17, 10, 34, 432883)'}),
