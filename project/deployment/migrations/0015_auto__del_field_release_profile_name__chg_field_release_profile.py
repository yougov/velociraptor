...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Release.profile'
        db.alter_column('deployment_release', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['deployment.Profile']))


    def backwards(self, orm):
        
        # Adding field 'Release.profile_name'
        db.add_column('deployment_release', 'profile_name', self.gf('django.db.models.fields.CharField')(default='temp', max_length=20), keep_default=False)

        # Changing field 'Release.profile'
        db.alter_column('deployment_release', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deployment.Profile'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 14, 8, 13, 799816)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 14, 8, 13, 799683)'}),
