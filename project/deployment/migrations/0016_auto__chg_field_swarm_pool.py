...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Swarm.pool'
        db.alter_column('deployment_swarm', 'pool', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Changing field 'Swarm.pool'
        db.alter_column('deployment_swarm', 'pool', self.gf('django.db.models.fields.CharField')(default='FIXME-UNSPECIFIED', max_length=50))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 23, 31, 9, 721972)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 23, 31, 9, 721839)'}),
        ...
        'deployment.swarm': {
            'Meta': {'unique_together': "(('profile', 'squad', 'proc_name'),)", 'object_name': 'Swarm'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
