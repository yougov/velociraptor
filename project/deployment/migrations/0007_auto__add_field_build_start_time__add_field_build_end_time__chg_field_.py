...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Build.start_time'
        db.add_column('deployment_build', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Build.end_time'
        db.add_column('deployment_build', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
        ...
        # Changing field 'Build.time'
        db.alter_column('deployment_build', 'time', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Build.start_time'
        db.delete_column('deployment_build', 'start_time')

        # Deleting field 'Build.end_time'
        db.delete_column('deployment_build', 'end_time')

        # User chose to not deal with backwards NULL issues for 'Build.file'
        raise RuntimeError("Cannot reverse this migration. 'Build.file' and its values cannot be restored.")

        # Changing field 'Build.time'
        db.alter_column('deployment_build', 'time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 11, 41, 21, 834959)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 11, 41, 21, 834838)'}),
        ...
        'deployment.build': {
            ...
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'})
        },
