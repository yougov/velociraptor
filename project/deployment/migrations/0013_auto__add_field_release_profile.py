...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('deployment_release', 'profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['deployment.Profile'], null=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 8, 16, 7, 399356)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 15, 8, 16, 7, 396301)'}),
