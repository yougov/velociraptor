...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for build in orm.Build.objects.all():
            build.start_time = build.time
            build.save()

    def backwards(self, orm):
        for build in orm.Build.objects.all():
            build.time = build.start_time
            build.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 11, 55, 51, 457254)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 11, 55, 51, 457125)'}),
