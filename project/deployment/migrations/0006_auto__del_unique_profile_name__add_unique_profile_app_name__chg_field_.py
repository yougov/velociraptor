...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('deployment_profile', ['name'])

        # Adding unique constraint on 'Profile', fields ['app', 'name']
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Profile', fields ['app', 'name']
        db.delete_unique('deployment_profile', ['app_id', 'name'])

        # Adding unique constraint on 'Profile', fields ['name']
        db.create_unique('deployment_profile', ['name'])

        # Changing field 'Build.time'
        db.alter_column('deployment_build', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 23, 1, 8, 298881)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 23, 1, 8, 298753)'}),
