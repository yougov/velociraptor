...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RecipeIngredient', fields ['ingredient', 'recipe']
        db.delete_unique('deployment_recipeingredient', ['ingredient_id', 'recipe_id'])

        # Removing unique constraint on 'ConfigRecipe', fields ['app', 'name']
        db.delete_unique('deployment_configrecipe', ['app_id', 'name'])

        # Deleting model 'ConfigRecipe'
        db.delete_table('deployment_configrecipe')

        # Deleting model 'RecipeIngredient'
        db.delete_table('deployment_recipeingredient')

        # Deleting field 'Release.recipe'
        db.delete_column('deployment_release', 'recipe_id')

        # Deleting field 'Swarm.recipe'
        db.delete_column('deployment_swarm', 'recipe_id')
    ...
    models = {
        ...
        'deployment.swarm': {
            'Meta': {'ordering': "['app__name', 'name', 'proc_name']", 'unique_together': "(('app', 'squad', 'proc_name'),)", 'object_name': 'Swarm'},
