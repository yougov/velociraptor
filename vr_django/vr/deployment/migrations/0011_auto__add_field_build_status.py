...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Build.status'
        db.add_column('deployment_build', 'status', self.gf('django.db.models.fields.CharField')(default='success', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Build.status'
        db.delete_column('deployment_build', 'status')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 12, 14, 50, 122582)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 11, 12, 14, 50, 122410)'}),
