...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Release.hash'
        db.alter_column('deployment_release', 'hash', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))


    def backwards(self, orm):
        
        # Changing field 'Release.hash'
        db.alter_column('deployment_release', 'hash', self.gf('django.db.models.fields.CharField')(default='', max_length=32))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 3, 22, 932151)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 3, 22, 932021)'}),
