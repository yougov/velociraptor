...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Build.time'
        db.add_column('deployment_build', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 18, 17, 50, 5, 116738), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Build.time'
        db.delete_column('deployment_build', 'time')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 17, 50, 5, 124357)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 18, 17, 50, 5, 123991)'}),
