...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Swarm.config_yaml'
        db.alter_column('deployment_swarm', 'config_yaml', self.gf('vr.deployment.fields.YAMLDictField')(null=True))

        # Changing field 'Swarm.env_yaml'
        db.alter_column('deployment_swarm', 'env_yaml', self.gf('vr.deployment.fields.YAMLDictField')(null=True))

    def backwards(self, orm):

        # Changing field 'Swarm.config_yaml'
        db.alter_column('deployment_swarm', 'config_yaml', self.gf('vr.deployment.fields.YAMLDictField')(default=''))

        # Changing field 'Swarm.env_yaml'
        db.alter_column('deployment_swarm', 'env_yaml', self.gf('vr.deployment.fields.YAMLDictField')(default=''))
