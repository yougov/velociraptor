...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Squad.balancer'
        db.delete_column('deployment_squad', 'balancer')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Squad.balancer'
        raise RuntimeError("Cannot reverse this migration. 'Squad.balancer' and its values cannot be restored.")
    ...
    models = {
        ...
        'deployment.swarm': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'balancer': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
