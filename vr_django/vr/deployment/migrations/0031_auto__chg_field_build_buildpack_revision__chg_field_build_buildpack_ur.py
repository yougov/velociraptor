...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Build.buildpack_revision'
        db.alter_column('deployment_build', 'buildpack_revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Build.buildpack_url'
        db.alter_column('deployment_build', 'buildpack_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Build.buildpack_revision'
        db.alter_column('deployment_build', 'buildpack_revision', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Build.buildpack_url'
        db.alter_column('deployment_build', 'buildpack_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'deployment.build': {
            ...
            'buildpack_revision': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
