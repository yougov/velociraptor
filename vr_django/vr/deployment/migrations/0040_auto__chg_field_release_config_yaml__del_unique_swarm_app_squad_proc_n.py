...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Swarm', fields ['app', 'squad', 'proc_name']
        db.delete_unique('deployment_swarm', ['app_id', 'squad_id', 'proc_name'])


        # Changing field 'Release.config_yaml'
        db.alter_column('deployment_release', 'config_yaml', self.gf('vr.deployment.fields.YAMLDictField')(null=True))
        # Adding unique constraint on 'Swarm', fields ['app', 'config_name', 'proc_name', 'squad']
        db.create_unique('deployment_swarm', ['app_id', 'config_name', 'proc_name', 'squad_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Swarm', fields ['app', 'config_name', 'proc_name', 'squad']
        db.delete_unique('deployment_swarm', ['app_id', 'config_name', 'proc_name', 'squad_id'])


        # Changing field 'Release.config_yaml'
        db.alter_column('deployment_release', 'config_yaml', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'deployment.swarm': {
            'Meta': {'ordering': "['app__name', 'config_name', 'proc_name']", 'unique_together': "(('app', 'config_name', 'squad', 'proc_name'),)", 'object_name': 'Swarm'},
